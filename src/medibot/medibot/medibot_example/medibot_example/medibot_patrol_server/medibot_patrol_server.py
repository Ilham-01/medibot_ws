...
from medibot_example.medibot_patrol_server.medibot_path \
    import MedibotPath
from medibot_msgs.action import Patrol


class MedibotPatrolServer(Node):

    def __init__(self):
        super().__init__('medibot_patrol_server')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Medibot patrol action server has been initialised.")
    ...
    *******************************************************************************"""
    ...
    async def execute_callback(self, goal_handle):
        ...
        while (feedback_msg.left_time > 0):
            ...
            # Give vel_cmd to Medibot
            twist = Twist()
            twist = MedibotPath.drive_circle(radius, speed)
