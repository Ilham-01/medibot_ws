...
using robotis::medibot::sensors::SensorState;
...
: Sensors(nh),
  ...
  sonar_(sonar)
{
  pub_ = nh->create_publisher<medibot_msgs::msg::SensorState>(topic_name, this->qos_);
...
{
  auto msg = std::make_unique<medibot_msgs::msg::SensorState>();
