#ifndef MEDIBOT_FAKE_NODE__MEDIBOT_FAKE_NODE_HPP_
#define MEDIBOT_FAKE_NODE__MEDIBOT_FAKE_NODE_HPP_
...
class MedibotFake : public rclcpp::Node
{
public:
  MedibotFake();
  ~MedibotFake();
...
#endif  // MEDIBOT_FAKE_NODE__MEDIBOT_FAKE_NODE_HPP_
